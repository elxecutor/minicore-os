...
void idt_init(void) {
    ...
    outb(0x21, 0x20);  // ICW2: Master PIC vector offset (IRQ0 = interrupt 32)
    outb(0x21, 0x04);  // ICW3: Tell master PIC there's a slave at IRQ2
    outb(0x21, 0x01);  // ICW4: 8086 mode

    // Slave PIC
    outb(0xA0, 0x11);  // ICW1: Initialize
    outb(0xA1, 0x28);  // ICW2: Slave PIC vector offset (IRQ8 = interrupt 40)
    ...
    // Set up IRQ handlers (IRQ0-15 mapped to interrupts 32-47)
